...
public class UpdateSiteTest {
	...
	public void testUpdateSiteLoad() throws Exception {
		...
		UpdateSite site = new SimpleUpdateSite(Constant.SIMPLE_UPDATESITE_ID, "file://D/Project/nsiq/simpleupdatecenter/");
		...
		assertThat(plugin.title, is("Hudson Coverage/Complexity Scatter Plot PlugIn"));
		assertThat(plugin.wiki, is("http://wiki.hudson-ci.org/display/HUDSON/Coverage+Complexity+Scatter+Plot+PlugIn"));
